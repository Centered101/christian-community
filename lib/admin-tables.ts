...
export const ADMIN_TABLES: Record<string, string[]> = {
  members: ["name", "name_en", "role", "avatar", "phone", "email", "birthday", "address", "join_date", "calling", "certificate_url", "certificate_expires_at", "testimony", "tags", "role_en", "calling_en", "testimony_en"],
